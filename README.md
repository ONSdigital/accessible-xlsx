...
This is a very simple wrapper for the [Documonster Excel module](https://github.com/documonster/documonster/blob/main/src/modules/excel/README.md) that allows accessible spreadsheets to be created with minimal configuration.
...
```html
<script src="https://unpkg.com/@onsvisual/accessible-xlsx@0.2.3/dist/accessible-xlsx.umd.js"></script>
```
...
A couple of client-side examples can be [found here](https://onsdigital.github.io/accessible-xlsx).
